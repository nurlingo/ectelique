    ...
    <div class="header-content clearfix"> <a class="logo" href="index.html"><img src="images/logo.png" alt=""></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li>+7 747 960 2806</li>
          <li><a href="mainlto:saken2316@gmail.com">saken2316@gmail.com</a></li>
        </ul>
      </nav>
...
<section id="hero" class="section ">
  <div class="container">
    <div class="row">
      <div class="col-md-2 col-sm-2 hero">
      </div>
      <div class="col-md-8 col-sm-8 hero">
        <div class="hero-content">

          <form id="form-contact" method="POST" class="form-element" autocomplete="off" action="post_form.php">
            <div class="form-group">
              <label for="exampleInputEmail">Name</label>
              <input name="name" type="form-text" class="form-control" id="exampleInputEmail" placeholder="Enter name">
            </div>
            <div class="form-group">
              <label for="exampleInputPhoneNumber">Phone number</label>
              <input name="phone" type="fomr-text" class="form-control" id="exampleInputPhoneNumber" placeholder="Phone number">
            </div>
            <div class="form-group">
              <label for="exampleInputPhoneNumber">Phone number</label>
              <textarea name="theme" class="form-control" id="exampleFormControlTextarea" rows="3" placeholder="Message"></textarea>
